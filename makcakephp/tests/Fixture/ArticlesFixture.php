...
class ArticlesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'articles_type_id_IDX' => ['type' => 'index', 'columns' => ['type_id'], 'length' => []],
        ],
        '_constraints' => [
            ...
            'articles_FK' => ['type' => 'foreign', 'columns' => ['type_id'], 'references' => ['types', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'published' => 1,
                'created' => '2021-01-18 12:09:49',
                'modified' => '2021-01-18 12:09:49',
                'type_id' => 1,
            ],
        ];
        parent::init();
